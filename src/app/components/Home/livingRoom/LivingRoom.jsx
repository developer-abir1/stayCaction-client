  ...
  return (
    <section className=" container  m-auto ">
                ...
                <div className="     cursor-pointer  px-4   card bg-white  gap-4  hover:shadow-xl my-4 mx-4 ">
                  <div>
                    <div className="relative">
                      <img src={livingRoom} className="rounded-xl " alt="" />
                      {isBig && (
      ...
      <div>
        <div className="  grid grid-cols-4 gap-4">
          {service.map((serv) => {
            const { thumbnail, _id, isBig, price, title, location, kitchen } =
              serv;
            return (
              <>
                <div className="     cursor-pointer  px-4   card bg-white  gap-4  hover:shadow-xl my-4 mx-4 ">
                  <div>
                    <div className="relative">
                      <img src={kitchen} className="rounded-xl " alt="" />
                      {isBig && (
                        <div className=" w-1/2 top-0  right-0 rounded-bl-3xl bg-secondary h-10   rounded-tr-xl  flex justify-center items-center  absolute">
                          <h2 className={`text-white   `}>
                            <span className="  ">{'Populer'}</span> Choice
                          </h2>
                        </div>
                      )}
                    </div>
